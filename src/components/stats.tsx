...
import { CalendarDays, Smartphone, Trophy, UserPlus, Users, UserStar, Zap } from "lucide-react"
          ...
          {stats.slice(0, 4).map((stat, idx) => (
            ...
            >
              ...
              <div className="relative flex items-center flex-col">
                ...
                <h1 className="text-4xl md:text-5xl font-black text-white mb-2">{stat.value}</h1>
          ...
          {stats.slice(4).map((stat, idx) => (
            ...
            >
              ...
              <div className="relative flex items-center flex-col gap-3">
                <div className="text-primary mb-4">{stat.icon}</div>
                <h1 className="text-4xl md:text-5xl font-black text-white mb-2 font-heading">{stat.value}</h1>
                <p className="text-sm uppercase tracking-wider text-muted-foreground">{stat.label}</p>
              </div>
            </div>
          ))}
